...
class FormContentChk extends Component {
	constructor(props) {
		super(props);
	...
	deleteTag = (state) => {
	  ...
	  this.props.onPress(data.defaultvalue, this.props.data);
	}
...
export default connectStyle( 'Component.FormContent', {} )(FormContentChk);
