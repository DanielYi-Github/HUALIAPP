...
export default {
  ...
  toolbarDefaultBg: platform === "ios" ? "#cf8a31" : "#cf8a31",
  ...
  CustomBottomNavigation:{
    iconIsImage          :true,
    icon_Home_active     :require("./moonFestival/Home-1.png"),
    icon_Home_inactive   :require("./moonFestival/Home.png"),
    icon_Find_active     :require("./moonFestival/Find-1.png"),
    icon_Find_inactive   :require("./moonFestival/Find.png"),
    icon_Message_active  :require("./moonFestival/Message-1.png"),
    icon_Message_inactive:require("./moonFestival/Message.png"),
    icon_Mine_active     :require("./moonFestival/Mine-1.png"),
    icon_Mine_inactive   :require("./moonFestival/Mine.png"),

    activeIconColor      :'#47ACF2',
    inactiveIconColor    :'#A1A1A1',
    activeLabelColor     :"#ba1406",
    inactiveLabelColor   :"#E65100",
    barColor             :"#f4ddc0",
    barColor_Home        :"#f4ddc0",
    barColor_Find        :"#f4ddc0",
    barColor_Message     :"#f4ddc0",
    barColor_Mine        :"#f4ddc0",
  ...
  ExplainIcon:{
    iconIsImage:true,
    icon1      :require("./moonFestival/1.png"),
    icon2      :require("./moonFestival/2.png"),
    icon3      :require("./moonFestival/3.png"),
    icon4      :require("./moonFestival/4.png"),
    icon5      :require("./moonFestival/5.png"),
    icon6      :require("./moonFestival/6.png"),
    icon7      :require("./moonFestival/7.png"),
