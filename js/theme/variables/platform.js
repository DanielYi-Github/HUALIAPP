...
export default {
  ...
  noticePageTextColor:"#000", // 公告消息使用的文字顏色
  ...
  CustomBottomNavigation:{
    ...
    activeIconColor      :'#47ACF2',
    inactiveIconColor    :'#A1A1A1',
    activeLabelColor     :"#47ACF2",
    inactiveLabelColor   :"#A1A1A1",
    barColor             :"#FFF",
    barColor_Home        :"#FFF",
    barColor_Find        :"#FFF",
    barColor_Message     :"#FFF",
    barColor_Mine        :"#FFF",
    pressColor           :'rgba(71, 172, 242, 0.16)',
    pressColor_Home      :"rgba(71, 172, 242, 0.16)",
    pressColor_Find      :"rgba(71, 172, 242, 0.16)",
    pressColor_Message   :"rgba(71, 172, 242, 0.16)",
    pressColor_Mine      :"rgba(71, 172, 242, 0.16)",
