...
* 顏色定義
  ...
  text                      :"#000000"
  label                     :"#575757"
  bottomNavigationBackground:"#f7d4d1"
...
export default {
  ...
  // Header
  toolbarBtnColor: "#fff",
  toolbarDefaultBg: "#9d012e",
  toolbarHeight: platform === "ios" ? 64 : 56,
  toolbarSearchIconSize: platform === "ios" ? 20 : 23,
  toolbarInputColor: "#fff", //輸入匡的背景顏色
  ...
  // Spinner
  defaultSpinnerColor: "rgba(255, 223, 0, 1)", // 初始畫面轉圈圈的顏色
  ...
  CustomBottomNavigation:{
    ...
    barColor             :"#f7d4d1",
    barColor_Home        :"#f7d4d1",
    barColor_Find        :"#f7d4d1",
    barColor_Message     :"#f7d4d1",
    barColor_Mine        :"#f7d4d1",
  ...
  HomePageBannerBackgroundColor:"rgba(160,11,21)",
