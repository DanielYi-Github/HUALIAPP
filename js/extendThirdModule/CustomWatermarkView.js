...
class CustomWatermarkView extends WatermarkView {

  renderWatermark() {
    HEIGHT = this.props.compontentHeight? this.props.compontentHeight: HEIGHT;
...
export default CustomWatermarkView;
